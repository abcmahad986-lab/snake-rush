...
export type GameMode = 'classic' | 'timed' | 'multiplayer' | 'event' | 'zen' | 'online' | 'survival';
export type Screen = 'login' | 'home' | 'menu' | 'game' | 'profile' | 'trophies' | 'titles' | 'shop' | 'events' | 'leaderboard' | 'settings' | 'rewards' | 'subscription' | 'battlepass' | 'online' | 'google' | 'characters' | 'chests' | 'achievements' | 'spinwheel' | 'visualthemes' | 'realmoney' | 'maps' | 'games' | 'privacy' | 'terms' | 'about' | 'snake-classic' | 'snake-rush' | 'snake-leader' | 'ludo' | 'puzzle' | 'runner' | 'battle' | 'maze';
